...
### Get coverage DB countries #############################
  ...
  # Where to save
  filename <- 'input-data/Output_5.zip'
  ...
  # Load data
  filename <- 'input-data/Output_5.csv'
...
### Preparations for scaling ########################################
  ...
  filename_f <- "input-data/UNe0_f.xlsx"
  filename_m <- "input-data/UNe0_m.xlsx"
...
### Apply scaling for all countries #################################
  ...
  ### Save
  write.csv(IFRs,"IFRs_EA_by_sex.csv",row.names=F)
...
### Calculate IFRs ##################################################
  ...
  # Save
  write.csv(Scenarios,"Scenarios_mf.csv",row.names = F)
